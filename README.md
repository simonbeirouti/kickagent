...
Drag the predefined widgets around the 24 × 14 snap grid, then use **Open live screen** on the
Public overlay tab and add that shareable URL as a 1920 × 1080 browser source. Public, phone, and
glasses layouts are saved independently in PostgreSQL.
